...
@NamedQueries({
    ...
    @NamedQuery(name = "Usuarios.findByEmailPass", query = "SELECT u FROM Usuarios u WHERE u.email = :email AND password = :password"),
...
public class Usuarios implements Serializable {
    ...
    public Usuarios(Integer idUsuario, String email) {
        this.idUsuario = idUsuario;
        this.email = email;
    }
    ...
    public String toString() {
        return "com.model.Usuarios[ idUsuario=" + idUsuario + " ]";
    }
